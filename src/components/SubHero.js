...
function SubHero() {
    return (
      ...
      <div id="top" className=" p-0 flex flex-col w-full xl:flex-row md:p-16 mb-4">
         <div className="w-full xl:w-9/12 grid lg:justify-items-end">
          <img src={phone2} className="pt-16 w-full xl:w-9/12" alt="Phone Mockup" />
      </div>
      <div className="flex text-center flex-col w-9/12 px-3 justify-center xl:w25/10 xl:text-left xl:pl-10">
          <h3 className="text-lg pt-10 text-gray-900 mb-3 font-light">
          Convenient Interaction
          </h3>
          <h2 className="text-4xl sm:text-6xl md:text-7xl 2xl:text-8xl font-black font-sans lg:mt-0 mt-4 text-dark-text py-0 mb-8">
          Modern App
